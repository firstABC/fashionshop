		...
		<header>
	        ...
	        <div class="list">
	        	<nav class="lay1200 clearfix">
	                 ...
	                 <a href="${pageContext.request.contextPath}/goods/toShoProduct" class="on">鞋类</a>
	            </nav>
	        </div>
		</header>
	</div>
	...
	<div class="main">
		...
		<div class="lay1200">
			<div class="tjContent clearfix">
				...
				<%
			      	List<Goods> ltGoodsShoes = (List<Goods>)request.getSession().getAttribute("ltGoodsShoes");
			      	if(ltGoodsShoes!=null&&ltGoodsShoes.size()>0){
			      		for(Goods good:ltGoodsShoes){
