...
<body>
		...
		<div class="lay1200 infoMy">
			<div class="info clearfix">
				...
				<form action="updateUser" method="post">
						...
						<p>用&nbsp;户&nbsp;名:<input type="text" name="userName" value="${user.userName}" placeholder="用户名"></p>
						<p>手&nbsp;机&nbsp;号:<input type="tel" name="userPhone" value="${user.userPhone}" placeholder="手机号" ></p>
						<p>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:<input type="email" name="userEmail" value="${user.userEmail}" placeholder="邮箱"></p>
						<p>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:<input type="password" name="userPwd" value="${user.userPwd}" placeholder="*******"></p>		
					
					<input type="submit" class="tj" value="确认修改" style="width:100px">
				</form>
				</div>
			</div>
	...
	<script type="text/javascript">
		$(function(){
			...
			('input').removeAttr('disabled').focus().addClass('focus');
			/* // 信息编辑
			$('.edit').click(function(){
